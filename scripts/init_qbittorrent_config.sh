...
ensure_ini_key "Preferences" "Downloads\\\\SavePath" "/config/downloads"
ensure_ini_key "Preferences" "Downloads\\\\TempPathEnabled" "true"
ensure_ini_key "Preferences" "Downloads\\\\TempPath" "/config/downloads/temp"
